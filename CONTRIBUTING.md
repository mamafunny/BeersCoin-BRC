# Contributing to Beerscoin Core

Beerscoin Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/BeersCoin/BeersCoin-BRC/labels/help%20wanted)
* [Projects](https://github.com/BeersCoin/BeersCoin-BRC/projects)
* [Beerscoindev on reddit](https://www.reddit.com/r/beerscoindev/)

## Branch Strategy

Beerscoin Core's default branch is intentionally a stable release, so that anyone
...
Beerscoin Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future Beerscoin Core
releases will automatically benefit from these.

When refactoring Beerscoin-specific code, please keep refactoring requests short,
...
The following applies to code changes to Beerscoin Core, and is not to be
confused with overall Beerscoin Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Beerscoin Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Beerscoin; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Beerscoin
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the Beerscoin consensus, it must have been
