...
/* Dogecoin 1.14.5: set the wallet's discard threshold to 1 BRC because that's what 97%
 ...
 */
/* Dogecoin 1.14.6: set the wallet's discard threshold to 0.01 BRC. Very network
...
/*
 * Beerscoin: Scaled to 1/10th of the recommended transaction fee to make RBF
...
/*
 * Beerscoin: Creating change outputs at exactly the dustlimit is counter-
...
public:
    ...
    /**
     * Beerscoin: Get a fee targetting a specific transaction speed.
     */
    CAmount GetBeerscoinPriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed);
    /**
     * Beerscoin: Get a fee targetting a specific transaction speed.
     */
    static CAmount GetBeerscoinPriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed, CAmount targetFee);
    /**
    ...
    /**
     * Return the minimum required fee taking into account the
     * floating relay fee and user set minimum transaction fee, but not the Beerscoin dust fee.
     */
