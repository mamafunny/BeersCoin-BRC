 ...
 *
 *  Beerscoin:    Increment mempool limits and accept RBF in steps of 0.0001 BRC
...
/**
 * Beerscoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Beerscoin: Default hard dust limit that is evaluated when considering whether
