...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Beerscoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Beerscoin (as there is no actual maximum coins)
