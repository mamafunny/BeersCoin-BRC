...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Beerscoin Core repository on GitHub"),
        tr("Services that claim to double your beerscoins are always ponzi schemes")
    };
