...
#define QAPP_ORG_NAME "Beerscoin"
#define QAPP_ORG_DOMAIN "beerscoin.com"
#define QAPP_APP_NAME_DEFAULT "Beerscoin-Qt"
#define QAPP_APP_NAME_TESTNET "Beerscoin-Qt-testnet"
