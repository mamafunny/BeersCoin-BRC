...
void Shutdown()
{
    ...
    RenameThread("beerscoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/BeersCoin/BeersCoin-BRC>";
    const std::string URL_WEBSITE = "<https://beerscoin.com>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("beerscoin-loadblk");
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // Beerscoin: Do we need to do any RPC mining init here?
