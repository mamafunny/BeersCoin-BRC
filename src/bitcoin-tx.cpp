...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s beerscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  beerscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded beerscoin transaction") + "\n" +
              "  beerscoin-tx [options] -create [commands]   " + _("Create hex-encoded beerscoin transaction") + "\n" +
              "\n";
