Beerscoin-Gebührenempfehlung
----------------------------

_zuletzt aktualisiert für 1.0.0_

Die Beerscoin-Kette hat ein relativ niedrigen Blockintervall, 1 Megabyte Blockspace
und zielt darauf ab, den Leuten eine kostengünstige Möglichkeit für Transaktionen zu bieten. Daher ist Spam die größte
Bedrohung für die Beerscoin-Kette als Ganzes. Beerscoin verwendet eine Transaktionsgebühr
und einen Dust-Abschreckungseffekt, um On-Chain-Spam zu bekämpfen.

Beerscoin Core implementiert eine Reihe von Standardeinstellungen in die Software, die die
...
parametrisiert werden sollten. Die empfohlenen Standardwerte, wie sie in der Beerscoin Core-Wallet implementiert sind, sind:

- **0,01 BRC pro Kilobyte** Transaktionsgebühr
- **0,01 BRC** Staubgrenze (Verwerfungsschwelle)
- **0,001 BRC** Ersetzung durch Gebühreninkremente
...
Gebühren werden über die genaue Größe einer Transaktion berechnet. Beispielsweise muss für eine 192-Byte-Transaktion nur eine BRC-Gebühr von `0,01 / 1000 * 192 = 0,00192` gezahlt werden.
...
genau auf die empfohlene Gebühr von **0,01 BRC/kB** festgelegt. Staubgrenzen werden durch
...
Die standardmäßige Mindesttransaktionsgebühr für Relay ist auf **0,001 BRC/kB** festgelegt,
...
- Das Hard Dust-Limit ist auf **0,001 BRC** festgelegt – Ausgaben unter diesem Wert sind
ungültig und werden abgelehnt.
- Das Soft Dust-Limit ist auf **0,01 BRC** festgelegt – beim Senden einer Transaktion mit Ausgaben
unter diesem Wert müssen für jede solche Ausgabe 0,01 BRC hinzugefügt werden, andernfalls
...
der Relay-Gebühr oder **0,0001 BRC** festgelegt.
